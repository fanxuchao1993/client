	...
	<div>
		...
		<div class="tableMenu">
		    ...
		    >
			    ...
			    <el-table-column prop="OVER_LAP_DEFF" label="新增差异占比(%)"></el-table-column>
		  	</el-table>
			<div class="block">
			    <el-pagination
		...
		created(){
	    		...
	    		tableData: [
		    		{
		    			...
		    			AUDIT_DATE:'1601476',
			          	...
			          	BUSI_TYPE_NAME: 'BOSS增量稽核3',
			         	GATEWAYTOTALNUM: '100.03%',
			          	CONSISNUM: 10086,
			          	ERRORNUM: 10086,
			          	SOURCE_SYSTEM: '每日上限',
			          	TOTAL_NUMB: '服务',
			          	AUDIT_POINT_ID: 'ATTRIBUTE'
			     	}
		        ],
		        options: [
		            {
	  	...
	  	methods: {
			...
			handleClick(row){
				...
				console.log(Object.assign({},params,hlrParam));
				this.$store.dispatch('setParamasInfo',Object.assign({},params,hlrParam));
				this.$router.push({name:'CrmHlrCheckBusiness'});
			},
