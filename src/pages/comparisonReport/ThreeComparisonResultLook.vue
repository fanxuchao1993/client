		    ...
		    >
			    ...
			    <el-table-column label="业务类型">
			    	<template slot-scope="scope">
			        	<el-button @click="handleClick(scope.row,scope.column)" type="text" size="small">{{scope.row.BUSI_TYPE_NAME}}</el-button>
			      	</template>
			    </el-table-column>
			    <el-table-column prop="DA" label="CRM系统参与比对数"></el-table-column>
			    <el-table-column prop="DB" label="MISC系统参与比对数"></el-table-column>
			    
			    <el-table-column prop="DC" label="平台系统参与比对数"></el-table-column>
