	...
	<div>
		...
		<div class="tableMenu">
			<div class="content-top">
				<div class="divStyle">
					<i class="iconfont icon-biaotishutiao6x25"></i>基础分析
				</div>
				<div class="clear"></div>
			</div>
			<el-table
			    ...
			    style="width: 100%"
		    >
			    <el-table-column prop="COMPARETABLESOURCESYSTEM" label="业务名称" width="150px">
...
<script>
	...
	import { getBaseDifferAnalyseSum as getBaseDifferAnalyseSum } from '@/api/Api'
	...
	export default{
		...
		methods: {
			...
			handleClickVipCust(row){
				...
				this.$router.push({name:"BaseAnalysisCust"});
			},
			handleClick(row) {
