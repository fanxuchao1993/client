	...
	<div>
		...
		<div class="pageLocal">
			<el-breadcrumb separator-class="el-icon-arrow-right">
			  	...
			  	<el-breadcrumb-item :to="this.$route.matched[2].path+'/ViceNumberCheck'">查看</el-breadcrumb-item>
		...
		<div class="tableMenu">
		    ...
		    >
			    ...
			    <el-table-column prop="BRAND_ID" label="当月品牌"></el-table-column>
			    ...
			    <el-table-column prop="SUB_BILL_ID" label="SUB_BILL_ID" width="120px"></el-table-column>
