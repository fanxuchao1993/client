	...
	<div>
		...
		<div class="tableMenu">
			<div class="content-top">
				...
				<el-select v-model="selectType" placeholder="稽核结果类型" clearable>
				    <el-option
...
<script>
	...
	export default{
		...
		created(){
			this.selectType = this.getParamas.pageResult;
	   	},
	  	data () {
	    	return {
	    		name:'A单边B单边不一致',
		        ...
		        options: [
		    		{
			          	RESULTTYPEID: 'A',
			          	RESULTTYPEMULTINAME: 'A单边(CRM)'
			        }, 
			        {
			          	RESULTTYPEID: 'B',
			          	RESULTTYPEMULTINAME: 'B单边(平台)'
			        }, 
			        {
			          	RESULTTYPEID: 'U',
			          	RESULTTYPEMULTINAME: '不一致'
			        }
		        ]
	    	}
	  	},
