	...
	<div>
		...
		<div class="tableMenu">
		    ...
		    >
			    ...
			    <el-table-column prop="AUDIT_POINT_NAME" label="稽核点名称" width="110px"></el-table-column>
			    ...
			    <el-table-column label="套餐分析" width='80px' fixed="right">
			    	<template slot-scope="scope">
			        	<el-button @click="handleClick(scope.row,scope.column)" type="text" size="small">查看</el-button>
			      	</template>
			    </el-table-column>
		...
		created(){
	  	...
	  	methods: {
			...
			handleClick(row,column){
				...
				let routeName;
				column.label==='分类汇总'?routeName='LocalWlanCheck':routeName='LocalWlanAnalysis';
