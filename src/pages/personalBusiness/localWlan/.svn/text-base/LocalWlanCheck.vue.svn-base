	...
	<div>
		...
		<div class="tableMenu">
		    ...
		    >
			    ...
			    <el-table-column prop="OPERATOR_NAME" label="业务名称" width='250px'></el-table-column>
		...
		created(){
	  	...
	  	methods: {
			...
			handleClick(row,column){
				...
				console.log(Object.assign({},params,resultType,operatorCode));
				this.$store.dispatch('setParamasInfo',Object.assign({},params,resultType,operatorCode));
				this.$router.push({name:'LocalWlanCheckABN'});				
			},
