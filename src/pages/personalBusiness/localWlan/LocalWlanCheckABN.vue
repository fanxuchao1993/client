	...
	<div>
		...
		<div class="pageLocal">
			<el-breadcrumb separator-class="el-icon-arrow-right">
			  	...
			  	<el-breadcrumb-item :to="this.$route.matched[2].path+'/localWlanCheck'">查看</el-breadcrumb-item>
		...
		<div class="tableMenu">
		    ...
		    >
			    ...
			    <el-table-column prop="PLATE_OPERATETIME_YM" label="PLATE_OPERATE_TIME_YM" width="210px"></el-table-column>
...
<script>
	import { getDetailWlan as getDetailWlan } from '@/api/Api'
