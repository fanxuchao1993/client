	...
	<div>
		...
		<div class="tableMenu">
		    <div class="content-top">
				<i class="iconfont icon-biaotishutiao6x25"></i>差异数订购
...
<script>
	...
	import { getDifferenceCountList as getDifferenceCountList } from '@/api/Api'
	export default{
		...
		methods: {
			...
			handleClick(row){
				...
				if (row.RESULTCLASS == '0') {
					this.$router.push({
			    	    name:'DifferenceOrderTypeADetails',
			        });
				} else if (row.RESULTCLASS == '1') {
					this.$router.push({
