	...
	<div>
		...
		<div class="pageLocal">
			<el-breadcrumb separator-class="el-icon-arrow-right">
			  	...
			  	<el-breadcrumb-item>CRM-BOSS稽核</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<!--数据表格-->
		<div class="tableMenu">
		    ...
		    >
			    ...
			    <el-table-column prop="TOPIC_NAME" label="专题名称" width='110px'></el-table-column>
		...
		created(){
	  	...
	  	methods: {
			...
			handleClick(row,column){
				...
				console.log(Object.assign({},bossParams,resultType));
				this.$store.dispatch('setParamasInfo',Object.assign({},bossParams,resultType));
				column.label==='分类汇总'?routeName='CrmBossAuditCheck':routeName='CrmBossAuditABN';
