	...
	<div>
		...
		<div class="pageLocal">
			<el-breadcrumb separator-class="el-icon-arrow-right">
			  	...
			  	<el-breadcrumb-item>CRM-HLR稽核</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<!--数据表格-->
		<div class="tableMenu">
		    ...
		    >
			    ...
			    <el-table-column label="一致率环比上月(%)">
			    	<template slot-scope="scope">
			        	{{scope.row.CONSIS_HUANBI}}%
			      	</template>
			    </el-table-column>
			    <el-table-column prop="TOTAL_DEF" label="总差异数" width='100px'></el-table-column>
		...
		created(){
	  	...
	  	methods: {
			...
			handleClick(row,column){
				...
				column.label==='分类汇总'?routeName='CrmHlrAuditCheck':routeName='CrmHlrAuditABN';
