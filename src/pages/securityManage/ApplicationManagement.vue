	...
	<div>
		...
		<div class="tableMenu">
			<div class="content-top">
				<div class="divStyle">
					<i class="iconfont icon-biaotishutiao6x25"></i>应用系统管理总览
				</div>
			</div>
...
<script>
	...
	export default{
		...
		data () {
	  	...
	  	created(){
	   		this.taskUrl = 'http://bmcccmp.bmcc.com.cn:8080/pure/AppSystem.action?loginId=admin&__PID=PURE_RESOURCESGROUP';
	   	},
		methods: {
	   	}
	}
